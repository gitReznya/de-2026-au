...
|---|---:|---|---|---|---|
| HQ-SRV | 120 | `192.168.120.0/27` | `255.255.255.224` | `192.168.120.1` | до 30 usable-адресов |
| HQ-CLI | 220 | `192.168.220.0/27` | `255.255.255.224` | `192.168.220.1` | не меньше 16 usable-адресов |
